      ...
      <div className="text-center max-w-2xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12 text-left">
          <div className="p-6 rounded-2xl bg-slate-900/50 border border-slate-800">
            ...
            <p className="text-sm text-slate-500">Ladda upp din Excel-fil och få automatisk analys av alla leverantörer.</p>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-slate-900/50 border border-slate-800">
            ...
            <p className="text-sm text-slate-500">Flera användare kan lägga till egna faktorer och kommentarer.</p>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-slate-900/50 border border-slate-800 flex flex-col">
            ...
            <p className="text-sm text-slate-500 leading-relaxed flex-1">Överskådlig vy med KPI:er, tier-fördelning och handlingsrekommendationer.</p>
          </div>
        </div>
