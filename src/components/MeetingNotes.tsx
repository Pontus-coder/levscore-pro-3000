          ...
          <div className="flex items-end gap-3">
            <div className="flex-1">
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-slate-900/50 border border-slate-700 rounded-lg text-slate-200 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500/50"
              />
            </div>
            <Button
              type="submit"
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center gap-3">
                        <input
                          ...
                          className="flex-1 px-3 py-2 bg-slate-900/50 border border-slate-700 rounded-lg text-slate-200 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500/50"
                        />
                        <Button
